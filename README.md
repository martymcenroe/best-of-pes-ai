...
<details><summary><b><a href="https://www.lfenergy.org/projects/openstef/">OpenSTEF</a></b> (🥇24 ·  ⭐ 140) - Automated ML pipelines for short-term energy forecasting. LF.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 47 · 🔀 47 · 📦 20 · 📋 200 - 29% open · ⏱️ 29.05.2026):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 120 · 🔀 640 · 📦 330 · 📋 550 - 21% open · ⏱️ 25.05.2026):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 48K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 37 · 🔀 63 · 📥 1.4K · 📦 39 · 📋 310 - 34% open · ⏱️ 29.05.2026):
...
- [PyPi](https://pypi.org/project/power-grid-model) (📥 94K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 4.8M · ⏱️ 30.05.2026):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 45 · 🔀 130 · 📦 120 · 📋 160 - 29% open · ⏱️ 21.04.2026):
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 72 · 📋 200 - 49% open · ⏱️ 13.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 110 / month):
	```
...
- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 140 · 📋 400 - 13% open · ⏱️ 28.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/grid2op) (📥 3.3K / month):
	```
	pip install grid2op
	```
</details>
...
- [GitHub](https://github.com/Grid2op/l2rpn-baselines) (👨‍💻 15 · 🔀 44 · 📋 30 - 43% open · ⏱️ 25.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/l2rpn-baselines) (📥 160 / month):
	```
...
- [GitHub](https://github.com/Grid2op/chronix2grid) (👨‍💻 16 · 🔀 10 · 📦 12 · 📋 60 - 70% open · ⏱️ 09.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/chronix2grid) (📥 860 / month):
	```
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 44 · 🔀 75 · 📦 28 · 📋 140 - 33% open · ⏱️ 29.05.2026):
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 39 · 🔀 51 · 📥 32K · 📋 680 - 14% open · ⏱️ 16.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 3.9K / month):
	```
	pip install helics
	```
</details>
...
- <b><a href="https://github.com/Carterbouley/ElectricityPricePrediction">Electricity Price Prediction</a></b> (🥇7 ·  ⭐ 77 · 💀) - Neural networks for day-ahead electricity price.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://raw.githubusercontent.com/ps-wiki/best-of-ps/main/config/icons/jupyter.ico" style="display:inline;" width="13" height="13"></code>
