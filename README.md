...
- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 44 · 🔀 42 · 📦 17 · 📋 180 - 28% open · ⏱️ 12.03.2026):

	```
	git clone https://github.com/OpenSTEF/openstef
	```
- [PyPi](https://pypi.org/project/openstef) (📥 4.2K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 110 · 🔀 630 · 📦 320 · 📋 530 - 20% open · ⏱️ 16.04.2026):
...
- [PyPi](https://pypi.org/project/pypsa) (📥 34K / month):
	...
	pip install pypsa
	```
- [Conda](https://anaconda.org/conda-forge/pypsa) (📥 220K · ⏱️ 25.02.2026):
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 35 · 🔀 60 · 📥 1.3K · 📦 39 · 📋 310 - 34% open · ⏱️ 17.04.2026):
...
- [PyPi](https://pypi.org/project/power-grid-model) (📥 100K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 4.6M · ⏱️ 16.04.2026):
	```
...
- <b><a href="https://pypsa-meets-earth.github.io/">PyPSA-Earth</a></b> (🥉19 ·  ⭐ 330) - First open-source global cross-sectoral energy system.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 45 · 🔀 120 · 📦 120 · 📋 160 - 28% open · ⏱️ 15.04.2026):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 4.5K / month):
	```
	pip install atlite
	```
- [Conda](https://anaconda.org/conda-forge/atlite) (📥 140K · ⏱️ 15.04.2026):
	```
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 74 · 📋 200 - 49% open · ⏱️ 13.02.2026):

	```
	git clone https://github.com/PowerGenome/PowerGenome
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 61 / month):
	```
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 66 · 🔀 1.4K · 📦 5.6K · 📋 360 - 54% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/yzhao062/pyod
	```
- [PyPi](https://pypi.org/project/pyod) (📥 2.3M / month):
	```
	pip install pyod
	```
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">Grid2Op</a></b> (🥇23 ·  ⭐ 420) - RL testbed for power grid operations. RTE France. L2RPN.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://raw.githubusercontent.com/ps-wiki/best-of-ps/main/config/icons/jupyter.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 140 · 📋 390 - 16% open · ⏱️ 04.02.2026):

	```
	git clone https://github.com/Grid2op/grid2op
	```
- [PyPi](https://pypi.org/project/grid2op) (📥 4.9K / month):
	```
	pip install grid2op
	```
</details>
...
- [GitHub](https://github.com/Grid2op/lightsim2grid) (👨‍💻 9 · 🔀 14 · 📥 300 · 📦 79 · 📋 62 - 24% open · ⏱️ 16.04.2026):

	```
	git clone https://github.com/Grid2op/lightsim2grid
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 33K / month):
	```
	pip install LightSim2Grid
	```
</details>
<details><summary><b><a href="https://github.com/Grid2op/l2rpn-baselines">L2RPN Baselines</a></b> (🥉14 ·  ⭐ 90 · 💤) - Baseline RL agents for L2RPN power grid competitions... <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://pytorch.org/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/Grid2op/l2rpn-baselines) (👨‍💻 15 · 🔀 44 · 📋 30 - 43% open · ⏱️ 25.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/l2rpn-baselines) (📥 190 / month):
	```
	pip install l2rpn-baselines
	```
</details>
<details><summary><b><a href="https://github.com/Grid2op/chronix2grid">Chronix2Grid</a></b> (🥉13 ·  ⭐ 24) - Synthetic time series generation for Grid2Op environments... <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/Grid2op/chronix2grid) (👨‍💻 16 · 🔀 10 · 📦 11 · 📋 59 - 69% open · ⏱️ 09.10.2025):

	```
	git clone https://github.com/Grid2op/chronix2grid
	```
- [PyPi](https://pypi.org/project/chronix2grid) (📥 130 / month):
	```
	pip install chronix2grid
	```
</details>
<details><summary><b><a href="https://github.com/emarche/RL2Grid">RL2Grid</a></b> (🥉7 ·  ⭐ 46) - RL benchmark for power grid operations. Built on Grid2Op... <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/statnett/Talk2PowerSystem) (👨‍💻 6 · 🔀 2 · 📋 18 - 11% open · ⏱️ 07.04.2026):
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 40 · 🔀 74 · 📦 27 · 📋 140 - 33% open · ⏱️ 18.04.2026):
