...
- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 49 · 🔀 48 · 📦 20 · 📋 200 - 27% open · ⏱️ 12.06.2026):

	```
	git clone https://github.com/OpenSTEF/openstef
	```
- [PyPi](https://pypi.org/project/openstef) (📥 5.5K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 120 · 🔀 650 · 📦 330 · 📋 560 - 22% open · ⏱️ 12.06.2026):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 67K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 37 · 🔀 66 · 📥 1.4K · 📦 39 · 📋 320 - 34% open · ⏱️ 11.06.2026):
...
- [PyPi](https://pypi.org/project/power-grid-model) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 4.9M · ⏱️ 12.06.2026):
	```
...
- [GitHub](https://github.com/PyPSA/pypsa-usa) (👨‍💻 16 · 🔀 47 · 📋 390 - 26% open · ⏱️ 11.05.2026):
...
- <b><a href="https://pypsa-meets-earth.github.io/">PyPSA-Earth</a></b> (🥉18 ·  ⭐ 340) - First open-source global cross-sectoral energy system.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 72 · 📋 200 - 49% open · ⏱️ 13.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 85 / month):
	```
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 68 · 🔀 1.5K · 📦 5.7K · 📋 360 - 52% open · ⏱️ 04.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/pyod) (📥 3.4M / month):
	```
	pip install pyod
	```
...
- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 140 · 📋 400 - 13% open · ⏱️ 12.06.2026):

	```
	git clone https://github.com/Grid2op/grid2op
	```
- [PyPi](https://pypi.org/project/grid2op) (📥 4.3K / month):
	```
	pip install grid2op
	```
</details>
<details><summary><b><a href="https://github.com/Grid2op/lightsim2grid">LightSim2Grid</a></b> (🥈23 ·  ⭐ 68) - Fast C++ backend for Grid2Op power flow computations... <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/Grid2op/chronix2grid) (👨‍💻 16 · 🔀 10 · 📦 12 · 📋 60 - 70% open · ⏱️ 09.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/chronix2grid) (📥 210 / month):
	```
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 44 · 🔀 77 · 📦 28 · 📋 140 - 32% open · ⏱️ 12.06.2026):

	```
	git clone https://github.com/gridstatus/gridstatus
	```
- [PyPi](https://pypi.org/project/gridstatus) (📥 99K / month):
	```
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 39 · 🔀 52 · 📥 32K · 📋 680 - 14% open · ⏱️ 16.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 3.5K / month):
	```
	pip install helics
	```
</details>
...
- <b><a href="https://github.com/e2nIEE/simbench">SimBench</a></b> (🥈21 ·  ⭐ 140) - Benchmark dataset of German LV/MV/HV grids for power.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://raw.githubusercontent.com/ps-wiki/best-of-ps/main/config/icons/jupyter.ico" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/andreluizbvs/InsPLAD">InsPLAD</a></b> (🥉5 ·  ⭐ 150 · 💀) - Power Line Asset Inspection Dataset. 10,607 UAV.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://pytorch.org/favicon.ico" style="display:inline;" width="13" height="13"></code>
</details>
<br>
