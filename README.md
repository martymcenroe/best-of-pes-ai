...
- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 51 · 🔀 50 · 📦 20 · 📋 200 - 20% open · ⏱️ 26.06.2026):

	```
	git clone https://github.com/OpenSTEF/openstef
	```
- [PyPi](https://pypi.org/project/openstef) (📥 18K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 120 · 🔀 650 · 📦 340 · 📋 570 - 20% open · ⏱️ 26.06.2026):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 81K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 38 · 🔀 67 · 📥 1.3K · 📦 40 · 📋 320 - 34% open · ⏱️ 26.06.2026):
...
- [PyPi](https://pypi.org/project/power-grid-model) (📥 100K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 5M · ⏱️ 26.06.2026):
	```
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 70 · 🔀 1.5K · 📦 5.7K · 📋 360 - 51% open · ⏱️ 17.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/pyod) (📥 4M / month):
	```
	pip install pyod
	```
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">Grid2Op</a></b> (🥇25 ·  ⭐ 440) - RL testbed for power grid operations. RTE France. L2RPN.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://raw.githubusercontent.com/ps-wiki/best-of-ps/main/config/icons/jupyter.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 140 · 📋 400 - 13% open · ⏱️ 18.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/grid2op) (📥 9.4K / month):
	```
	pip install grid2op
	```
</details>
...
- [GitHub](https://github.com/Grid2op/l2rpn-baselines) (👨‍💻 15 · 🔀 44 · 📋 30 - 43% open · ⏱️ 25.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/l2rpn-baselines) (📥 340 / month):
	```
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 44 · 🔀 77 · 📦 28 · 📋 140 - 33% open · ⏱️ 25.06.2026):
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 39 · 🔀 52 · 📥 32K · 📋 680 - 14% open · ⏱️ 16.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 2.7K / month):
	```
	pip install helics
	```
</details>
