...
- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 44 · 🔀 41 · 📦 17 · 📋 180 - 27% open · ⏱️ 12.03.2026):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 110 · 🔀 620 · 📦 320 · 📋 530 - 20% open · ⏱️ 03.04.2026):
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 34 · 🔀 60 · 📥 1.3K · 📦 39 · 📋 300 - 35% open · ⏱️ 01.04.2026):
...
- [PyPi](https://pypi.org/project/power-grid-model) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 4.6M · ⏱️ 01.04.2026):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 45 · 🔀 120 · 📦 120 · 📋 160 - 28% open · ⏱️ 25.03.2026):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 5.3K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 75 · 📋 200 - 48% open · ⏱️ 13.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 55 / month):
	```
...
<details><summary><b><a href="https://pyod.readthedocs.io/">PyOD</a></b> (🥇37 ·  ⭐ 9.8K) - 50+ anomaly detection algorithms. 26M+ downloads. Widely used for grid.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 65 · 🔀 1.4K · 📦 5.6K · 📋 360 - 54% open · ⏱️ 27.02.2026):
...
- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 140 · 📋 390 - 15% open · ⏱️ 04.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/grid2op) (📥 3.8K / month):
	```
	pip install grid2op
	```
</details>
<details><summary><b><a href="https://github.com/Grid2op/lightsim2grid">LightSim2Grid</a></b> (🥈22 ·  ⭐ 63) - Fast C++ backend for Grid2Op power flow computations... <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/Grid2op/lightsim2grid) (👨‍💻 9 · 🔀 14 · 📥 300 · 📦 78 · 📋 62 - 27% open · ⏱️ 05.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 26K / month):
	```
...
- [GitHub](https://github.com/Grid2op/l2rpn-baselines) (👨‍💻 15 · 🔀 44 · 📋 30 - 43% open · ⏱️ 25.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/l2rpn-baselines) (📥 240 / month):
	```
	pip install l2rpn-baselines
	```
</details>
<details><summary><b><a href="https://github.com/Grid2op/chronix2grid">Chronix2Grid</a></b> (🥉12 ·  ⭐ 24) - Synthetic time series generation for Grid2Op environments... <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/Grid2op/chronix2grid) (👨‍💻 16 · 🔀 10 · 📦 9 · 📋 59 - 69% open · ⏱️ 09.10.2025):

	```
	git clone https://github.com/Grid2op/chronix2grid
	```
- [PyPi](https://pypi.org/project/chronix2grid) (📥 100 / month):
	```
	pip install chronix2grid
	```
</details>
<details><summary><b><a href="https://github.com/emarche/RL2Grid">RL2Grid</a></b> (🥉5 ·  ⭐ 43) - RL benchmark for power grid operations. Built on Grid2Op... <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- <b><a href="https://github.com/GitX123/microgrid-ems-drl">Microgrid EMS DRL</a></b> (🥉2 ·  ⭐ 50 · 💀) - Deep RL for battery management in microgrids with.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
<details><summary><b><a href="https://github.com/statnett/Talk2PowerSystem">Talk2PowerSystem</a></b> (🥇10 ·  ⭐ 11) - Natural language interface for querying CIM-based.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/statnett/Talk2PowerSystem) (👨‍💻 6 · 🔀 2 · 📋 18 - 11% open · ⏱️ 03.04.2026):
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 40 · 🔀 73 · 📦 26 · 📋 140 - 33% open · ⏱️ 04.04.2026):

	```
	git clone https://github.com/gridstatus/gridstatus
	```
- [PyPi](https://pypi.org/project/gridstatus) (📥 86K / month):
	```
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 39 · 🔀 51 · 📥 32K · 📋 680 - 13% open · ⏱️ 16.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 5.7K / month):
	```
	pip install helics
	```
</details>
