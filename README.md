...
- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 44 · 🔀 41 · 📦 17 · 📋 170 - 23% open · ⏱️ 12.03.2026):

	```
	git clone https://github.com/OpenSTEF/openstef
	```
- [PyPi](https://pypi.org/project/openstef) (📥 5.6K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 110 · 🔀 610 · 📦 320 · 📋 520 - 20% open · ⏱️ 20.03.2026):
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 34 · 🔀 60 · 📥 1.5K · 📦 38 · 📋 300 - 35% open · ⏱️ 18.03.2026):
...
- [PyPi](https://pypi.org/project/power-grid-model) (📥 100K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 4.5M · ⏱️ 18.03.2026):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 45 · 🔀 120 · 📦 120 · 📋 160 - 28% open · ⏱️ 13.03.2026):
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 75 · 📋 200 - 49% open · ⏱️ 13.02.2026):

	```
	git clone https://github.com/PowerGenome/PowerGenome
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 74 / month):
	```
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 65 · 🔀 1.4K · 📦 5.6K · 📋 360 - 55% open · ⏱️ 27.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/pyod) (📥 1.3M / month):
	```
	pip install pyod
	```
...
- [GitHub](https://github.com/Grid2op/lightsim2grid) (👨‍💻 9 · 🔀 14 · 📥 300 · 📦 77 · 📋 61 - 26% open · ⏱️ 05.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 20K / month):
	```
...
- [GitHub](https://github.com/Grid2op/l2rpn-baselines) (👨‍💻 15 · 🔀 44 · 📋 30 - 43% open · ⏱️ 25.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/l2rpn-baselines) (📥 130 / month):
	```
...
<details><summary><b><a href="https://github.com/emarche/RL2Grid">RL2Grid</a></b> (🥉6 ·  ⭐ 42) - RL benchmark for power grid operations. Built on Grid2Op... <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- <b><a href="https://github.com/GitX123/microgrid-ems-drl">Microgrid EMS DRL</a></b> (🥉2 ·  ⭐ 49 · 💀) - Deep RL for battery management in microgrids with.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code>
</details>
<br>
...
<details><summary><b><a href="https://github.com/statnett/Talk2PowerSystem">Talk2PowerSystem</a></b> (🥇9 ·  ⭐ 10) - Natural language interface for querying CIM-based.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/statnett/Talk2PowerSystem) (👨‍💻 6 · 🔀 2 · 📋 18 - 11% open · ⏱️ 18.03.2026):
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 40 · 🔀 72 · 📦 26 · 📋 130 - 32% open · ⏱️ 18.03.2026):

	```
	git clone https://github.com/gridstatus/gridstatus
	```
- [PyPi](https://pypi.org/project/gridstatus) (📥 71K / month):
	```
...
- <b><a href="https://github.com/Grid2op/grid2viz">Grid2Viz</a></b> (🥇14 ·  ⭐ 56 · 💀) - Visualization tool for Grid2Op power grid environments. Agent.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code>
