...
- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 44 · 🔀 41 · 📦 17 · 📋 170 - 23% open · ⏱️ 12.03.2026):
	...
	```
- [PyPi](https://pypi.org/project/openstef) (📥 7.5K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 110 · 🔀 610 · 📦 320 · 📋 520 - 19% open · ⏱️ 11.03.2026):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 31K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 34 · 🔀 58 · 📥 1.5K · 📦 38 · 📋 300 - 35% open · ⏱️ 13.03.2026):
...
- [PyPi](https://pypi.org/project/power-grid-model) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 4.5M · ⏱️ 12.03.2026):
	```
...
<details><summary><b><a href="https://github.com/PyPSA/atlite">Atlite</a></b> (🥇24 ·  ⭐ 370) - Calculating renewable power potentials from weather data. Part of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 45 · 🔀 120 · 📦 120 · 📋 150 - 28% open · ⏱️ 13.03.2026):
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 75 · 📋 190 - 48% open · ⏱️ 13.02.2026):

	```
	git clone https://github.com/PowerGenome/PowerGenome
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 170 / month):
	```
...
- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 140 · 📋 390 - 15% open · ⏱️ 04.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/grid2op) (📥 3K / month):
	```
	pip install grid2op
	```
</details>
...
- [GitHub](https://github.com/Grid2op/lightsim2grid) (👨‍💻 9 · 🔀 14 · 📥 300 · 📦 76 · 📋 61 - 26% open · ⏱️ 05.02.2026):

	```
	git clone https://github.com/Grid2op/lightsim2grid
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 19K / month):
	```
...
- [GitHub](https://github.com/Grid2op/chronix2grid) (👨‍💻 16 · 🔀 9 · 📦 9 · 📋 59 - 69% open · ⏱️ 09.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/chronix2grid) (📥 180 / month):
	```
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 40 · 🔀 72 · 📦 25 · 📋 130 - 32% open · ⏱️ 14.03.2026):

	```
	git clone https://github.com/gridstatus/gridstatus
	```
- [PyPi](https://pypi.org/project/gridstatus) (📥 66K / month):
	```
...
- <b><a href="https://github.com/Grid2op/grid2viz">Grid2Viz</a></b> (🥇15 ·  ⭐ 56 · 💀) - Visualization tool for Grid2Op power grid environments. Agent.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code>
