...
- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 44 · 🔀 45 · 📦 17 · 📋 180 - 28% open · ⏱️ 12.03.2026):

	```
	git clone https://github.com/OpenSTEF/openstef
	```
- [PyPi](https://pypi.org/project/openstef) (📥 4.5K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 110 · 🔀 640 · 📦 320 · 📋 540 - 20% open · ⏱️ 25.04.2026):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 38K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 36 · 🔀 61 · 📥 1.4K · 📦 39 · 📋 310 - 34% open · ⏱️ 30.04.2026):
...
- [PyPi](https://pypi.org/project/power-grid-model) (📥 100K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 4.7M · ⏱️ 30.04.2026):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 45 · 🔀 120 · 📦 120 · 📋 160 - 28% open · ⏱️ 21.04.2026):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 3.9K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 73 · 📋 200 - 49% open · ⏱️ 13.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 93 / month):
	```
...
- [GitHub](https://github.com/Grid2op/lightsim2grid) (👨‍💻 9 · 🔀 14 · 📥 300 · 📦 80 · 📋 62 - 24% open · ⏱️ 21.04.2026):
	...
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 35K / month):
	```
...
- [GitHub](https://github.com/Grid2op/chronix2grid) (👨‍💻 16 · 🔀 10 · 📦 12 · 📋 60 - 70% open · ⏱️ 09.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/chronix2grid) (📥 1K / month):
	```
...
- [GitHub](https://github.com/Grid2op/l2rpn-baselines) (👨‍💻 15 · 🔀 44 · 📋 30 - 43% open · ⏱️ 25.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/l2rpn-baselines) (📥 56 / month):
	```
...
- [GitHub](https://github.com/emarche/RL2Grid) (🔀 8 · 📋 5 - 40% open · ⏱️ 15.04.2026):
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 41 · 🔀 75 · 📦 28 · 📋 140 - 33% open · ⏱️ 28.04.2026):
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 39 · 🔀 52 · 📥 32K · 📋 680 - 13% open · ⏱️ 16.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 4.9K / month):
	```
	pip install helics
	```
</details>
...
- <b><a href="https://www2.econ.iastate.edu/tesfatsi/AMESMarketHome.htm">AMES Market</a></b> (🥉5 ·  ⭐ 33) - Agent-based wholesale power market test bed. Iowa State.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code>
</details>
