...
- [GitHub](https://github.com/OpenSTEF/openstef) (👨‍💻 52 · 🔀 52 · 📥 21 · 📦 20 · 📋 200 - 17% open · ⏱️ 10.07.2026):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 120 · 🔀 660 · 📦 340 · 📋 580 - 19% open · ⏱️ 09.07.2026):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 98K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 39 · 🔀 71 · 📥 1.6K · 📦 40 · 📋 320 - 34% open · ⏱️ 10.07.2026):

	```
	git clone https://github.com/PowerGridModel/power-grid-model
	```
- [PyPi](https://pypi.org/project/power-grid-model) (📥 82K / month):
	```
	pip install power-grid-model
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 5.1M · ⏱️ 10.07.2026):
	```
...
- <b><a href="https://pypsa-meets-earth.github.io/">PyPSA-Earth</a></b> (🥉19 ·  ⭐ 350) - First open-source global cross-sectoral energy system.. <code>❗Unlicensed</code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 45 · 🔀 130 · 📦 120 · 📋 160 - 30% open · ⏱️ 09.07.2026):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 6.3K / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 71 · 📋 200 - 49% open · ⏱️ 13.02.2026):
	...
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 130 / month):
	```
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 70 · 🔀 1.5K · 📦 5.7K · 📋 360 - 51% open · ⏱️ 17.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/pyod) (📥 4.5M / month):
	```
	pip install pyod
	```
...
- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 140 · 📋 400 - 13% open · ⏱️ 18.06.2026):
	...
	```
- [PyPi](https://pypi.org/project/grid2op) (📥 13K / month):
	```
	pip install grid2op
	```
</details>
...
- [GitHub](https://github.com/Grid2op/lightsim2grid) (👨‍💻 9 · 🔀 14 · 📥 300 · 📦 88 · 📋 63 - 25% open · ⏱️ 21.04.2026):
...
<details><summary><b><a href="https://github.com/emarche/RL2Grid">RL2Grid</a></b> (🥉7 ·  ⭐ 50) - RL benchmark for power grid operations. Built on Grid2Op... <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 44 · 🔀 79 · 📦 28 · 📋 140 - 32% open · ⏱️ 06.07.2026):
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 39 · 🔀 52 · 📥 33K · 📋 680 - 14% open · ⏱️ 16.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 3.3K / month):
	```
	pip install helics
	```
</details>
